    ...
    public class Lab03 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            foreach (ModelMesh mesh in torusModel.Meshes)
                ...
                {
                    effect.Alpha = 1; // bug in MonoGame!
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            else if (Input.IsKeyDown(Keys.LeftControl) || Input.IsKeyDown(Keys.RightControl))
            {
                // Rotate Torus
            ...
            // ^ is the XOR operator
            if (isPerspective ^= Input.IsKeyPressed(Keys.Tab))
            ...
            if (isSRT ^= Input.IsKeyPressed(Keys.Space))
